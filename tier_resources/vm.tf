module "VM_01" {
    ...
    storageOSDiskManagedDiskType          =  var.VM_01_storageOSDiskManagedDiskType
    storageOSDiskSize                     =  var.VM_01_storageOSDiskSize
...
# module "VM_01_backup" {
#   source                                = "./terraform_vm_backup_module"  
#   resource_group_name                   =  module.app_rg.concatenated_name
#   recovery_vault_name                   =  module.app_pattern.rsv_name
#   backup_policy_id                      =  module.backup_policy.backup_policy_id[0]
#   source_vm_id                          =  module.VM_01.linux_vm_id
#   azvm_backup_input                     =  var.VM_01_azvm_backup_input
# }